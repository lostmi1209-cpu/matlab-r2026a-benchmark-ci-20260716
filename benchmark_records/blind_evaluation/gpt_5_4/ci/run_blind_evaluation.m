...
%RUN_BLIND_EVALUATION Execute and score three frozen GPT-5.4 solutions.
...
summary.evaluation_type = 'no_context_gpt_5_4_one_shot_pretest';
summary.candidate_model = 'gpt-5.4';
summary.model_reasoning_effort = 'xhigh';
summary.one_shot = true;
summary.matlab_feedback_before_solution_freeze = false;
